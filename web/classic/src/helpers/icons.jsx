...
/**
 * Heavy icon imports — this module is NOT re-exported through helpers/index.js
 * so that @lobehub/icons (~3.8MB) and react-icons are only loaded on pages
 * that actually need them (channels, models, pricing, etc.).
 */

import i18next from 'i18next';
import { Tag, Avatar } from '@douyinfe/semi-ui';
import { Layers } from 'lucide-react';
import { stringToColor } from './render';
...
/**
 * Render custom OAuth provider icon
 */

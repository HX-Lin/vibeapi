...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-vibeapi-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-vibeapi-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-vibeapi-container') return true;
      return (

...
CLUSTER_LEADER_ENABLED=${CLUSTER_LEADER_ENABLED:-false}
CLUSTER_NODE_ID=${CLUSTER_NODE_ID:-${NODE_NAME:-vibeapi-node-1}}
CLUSTER_LEASE_TTL_SECONDS=${CLUSTER_LEASE_TTL_SECONDS:-30}
CLUSTER_LEASE_RENEW_INTERVAL_SECONDS=${CLUSTER_LEASE_RENEW_INTERVAL_SECONDS:-10}
